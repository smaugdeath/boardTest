...
<form id="hiddenFrm" action="${cp }/deleteAtf" method="post">
	...
	<input id="parentPostNum" name="parentPostNum" value="${parentPostNum }" type="hidden">
	<input id="postTitle" name="postTitle" value="${pvo.postTitle }" type="hidden">
	<input id="postContent" name="postContent" value="${pvo.postContent }" type="hidden">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<form id="frm" class="form-horizontal" role="form" action="${cp }/modifyPost"
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="text" class="form-control" id="postTitle" name="postTitle"
								placeholder="TITLE" value="${pvo.postTitle }"/>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<textarea name="smarteditor" id="smarteditor" rows="10" cols="100" style="width:766px; height:412px;">${pvo.postContent }</textarea>
						</div>
					</div>
